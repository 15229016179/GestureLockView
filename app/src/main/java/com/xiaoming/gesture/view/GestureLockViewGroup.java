package com.xiaoming.gesture.view;
...
public class GestureLockViewGroup extends RelativeLayout {
	 ...
	 */
	private int mNoFingerOuterCircleColor = 0xAA05C1CB;
	/**
	 * GestureLockView手指触摸的状态下内圆和外圆的颜色
	 */
	private int mFingerOnColor = 0xFF05C1CB;
	/**
	 * GestureLockView手指抬起的状态下内圆和外圆的颜色
	 */
	private int mFingerUpColor = 0xFF05C1CB;
...
//			mGestureLockViewWidth = (int) (4 * mWidth * 1.0f / (5 * mCount + 1));
			mGestureLockViewWidth = (int) (mWidth/ (mCount + 2));
